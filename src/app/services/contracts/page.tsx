...
export default function ContractsServicePage() {
  ...
  const SUB = "Drafting and negotiating agreements that protect your interests.";
  const bullets = [
        ...
        <div className="mx-auto max-w-4xl px-4 md:px-6">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            ...
            <Card><CardContent className="p-6">
              ...
              <p className="mt-3 flex items-center gap-2 text-sm text-slate-600"><Clock4 className="h-4 w-4" /> Typical turnaround 5–7 business days.</p>
            </CardContent></Card>
          </div>
