...
import { Briefcase, CheckCircle2, Clock4, ShieldCheck } from "lucide-react";

export default function BusinessServicePage() {
  const TITLE = "Business & Startup Counsel";
  const SUB = "Practical, on-call counsel for formation, governance, and deals.";
  const bullets = [
    ...
    <main className="text-slate-800">
      <section className="bg-gradient-to-b from-white to-slate-50 py-16">
        <div className="mx-auto max-w-4xl px-4 md:px-6">
          <div className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600"><Briefcase /></div>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            ...
            <Card><CardContent className="p-6">
              ...
              <p className="mt-3 flex items-center gap-2 text-sm text-slate-600"><Clock4 className="h-4 w-4" /> Typical kickoff within a week.</p>
            </CardContent></Card>
          </div>
