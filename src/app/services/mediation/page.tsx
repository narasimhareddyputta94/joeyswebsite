      ...
      <section className="bg-gradient-to-b from-white to-slate-50 py-16">
        <div className="mx-auto max-w-4xl px-4 md:px-6">
          ...
          <div className="mt-6 flex gap-3">
            <Button asChild className="rounded-full px-6"><Link href="/contact">Talk to a mediator</Link></Button>
            <Button asChild variant="outline" className="rounded-full"><Link href="/results">See results</Link></Button>
          </div>
          <p className="mt-2 flex items-center gap-2 text-xs text-slate-500"><ShieldCheck className="h-4 w-4" /> Confidentiality confirmed before any session begins.</p>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            ...
            <Card><CardContent className="p-6">
              ...
              <p className="mt-3 flex items-center gap-2 text-sm text-slate-600"><Clock4 className="h-4 w-4" /> Most mediations resolve in 1–2 sessions.</p>
            </CardContent></Card>
          </div>
